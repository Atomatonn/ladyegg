...
@Component({
  selector: 'app-ladys-lair',
  templateUrl: './ladys-lair.component.html',
  styleUrls: ['./ladys-lair.component.scss']
})
export class LadysLairComponent implements OnInit {
  ...
  onMouseMove(event: MouseEvent) {
    ...
    for(var i=0;i<2;i++){
      eyes[i].setAttribute('style', `left: ${x}; top: ${y}; transform: translate(-'${x}',-'${y}')`);
    }
  }
  ...
  resetEggs() {
    if(!$('.egg-emotion').length) {// Start here
        this.moar();
    } else {
  ...
  moar() { 
    ...
    $(function() {
        ...
        var functions = [
            ...
            function fibsh() {
                var audio = new Audio('../../assets/audio/degg.mp3');
                audio.play();
            },

            function degg() {
                var audio = new Audio('../../assets/audio/fibsh.mp3');
                audio.play();
            },

            function ahh() {
                var audio = new Audio('../../assets/audio/migph.mp3');
                audio.play();
            },

            function murph() {
                var audio = new Audio('../../assets/audio/ahhhhh.mp3');
                audio.play();
            }
        ];
